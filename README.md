...
This workflow runs manually or on every push to main (in this case only for the original repository) and pushes images to GHCR under `ghcr.io/<owner>/<repo>` with two tags for each image:
