...
# Last updated on 2025-11-28 17:47:13.411608.
    ...
    "checkouts": {
        ...
        "query": """
                ...
                DO UPDATE SET
                    ...
                    origin = COALESCE(checkouts.origin, EXCLUDED.origin),
    ...
    "issues": {
        ...
        "query": """
                ...
                DO UPDATE SET
                    ...
                    id = COALESCE(issues.id, EXCLUDED.id),
                    version = COALESCE(issues.version, EXCLUDED.version),
                    origin = COALESCE(issues.origin, EXCLUDED.origin),
    ...
    "builds": {
        ...
        "query": """
                ...
                DO UPDATE SET
                    ...
                    checkout_id = COALESCE(builds.checkout_id, EXCLUDED.checkout_id),
                    id = COALESCE(builds.id, EXCLUDED.id),
                    origin = COALESCE(builds.origin, EXCLUDED.origin),
    ...
    "tests": {
        ...
        "query": """
                ...
                DO UPDATE SET
                    ...
                    build_id = COALESCE(tests.build_id, EXCLUDED.build_id),
                    id = COALESCE(tests.id, EXCLUDED.id),
                    origin = COALESCE(tests.origin, EXCLUDED.origin),
    ...
    "incidents": {
        ...
        "query": """
                ...
                DO UPDATE SET
                    ...
                    id = COALESCE(incidents.id, EXCLUDED.id),
                    origin = COALESCE(incidents.origin, EXCLUDED.origin),
                    issue_id = COALESCE(incidents.issue_id, EXCLUDED.issue_id),
                    issue_version = COALESCE(incidents.issue_version, EXCLUDED.issue_version),
